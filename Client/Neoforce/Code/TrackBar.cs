...
namespace TomShane.Neoforce.Controls
{
    ...
    public class TrackBar : Control
    {
        ...
        private bool sliderButtonVisible = true;
        ////////////////////////////////////////////////////////////////////////////
        ...
        //////////////////////////////////////////////////////////////////////////// 
        // Slider Button Visibility added By Ittipon <ittipon.bay@gmail.com>
        public virtual bool SliderButtonVisible
        {
            get
            {
                return sliderButtonVisible;
            }
            set
            {
                sliderButtonVisible = value;
                if (btnSlider != null) btnSlider.Visible = value;
            }
        }
        ...
        protected override void DrawControl(Renderer renderer, Rectangle rect, GameTime gameTime)
        {
            ...
            // Slider Button Visibility - if not visible change track length
            if (!btnSlider.Visible)
                w = (int)Math.Ceiling(px * (rect.Width - p.ContentMargins.Horizontal)) + 2;
        ...
        void btnSlider_Move(object sender, MoveEventArgs e)
        {
            ...
            // Slider Button Visibility - if not visible change track length
            if (!btnSlider.Visible)
                w = Width - p.ContentMargins.Horizontal;
